...
if save_res_:
    ...
    # out_video = cv2.VideoWriter('tests/results/tmp/{}.mp4'.format(datetime.datetime.now()), fourcc, 20, frame_out_wh)
...
if analyze_log_:
    try:
        ...
        print('performance_analysis error!')
    try:
